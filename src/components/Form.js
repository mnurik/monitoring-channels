...
const Form = ({ currentChannel, onSave, onChangeData, onChangeList, onCloseModal }) => <div className="col-sm-8">
  <button type='button' className='btn btn-default pull-left' data-toggle='modal' data-target='#channelModal'>Yeni</button>
